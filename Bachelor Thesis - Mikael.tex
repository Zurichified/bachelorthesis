...
\noindent If we call the benchmarks which have a RCIW99 value above 60\% unstable benchmarks, then there are in total 19 benchmarks from 6 projects which are unstable. Table \ref{table:unstable} shows in detail the RCIW99 values of benchmarks and which projects they are from.
